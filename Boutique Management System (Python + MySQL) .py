...
def sign_in():
    try:
        ...
        if ask in list_of_ids:
            while True:
                print(''' Do you want to :1) View Bookings 2) Book a product 3) Update Self Details 4) Cancel booked products  enter 'back' to exit ''')
                ...
                if ccc == '4':
                    ...
                    try:
                        ...
                        if bkd_pro is None or bkd_pro == ' ':
                            ...
                            cw = input("To cancel all products; enter enter the product code to cancel : ")
                            if cw in 'Aa':
...
def emp_sign_in():
    try:
        ...
        if ask not in lis:
            ...
            while True:
                space()
                ccc = input("1. Update delivered records 2. Add a New Product 3. Delete a product Enter 'Back' to logout: ")
                if ccc == '1':
...
def employer(): 
    while True:
        print()
        print('''Enter Your Choice:1)View Product Details 2)Add a New Employee enter back to exit''')
...
print('WELCOME !')
while True:
    print('''Are you a : (A). Customer(B). Employee (C). Employer enter e to exit ''')
    ch = input('Enter - ')
    if ch in 'aA':
